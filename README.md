...
- **custom_dataset.py:**
  ...
  - Objetivo: Para evitar cargar todas las imágenes y máscaras en memoria, se creó el custom dataset para obtener imágenes en el momento de su utilización --> Lazy load.
